  ...
  return (
    <motion.section className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 scroll-mt-28"
        ...
        <p className="mb-3">
            ...
            <a href="https://www.youtube.com/watch?v=FxfTaQOJHsA" target="_blank" className="font-medium text-blue-400 hover:text-gray-800">apprendre de nouvelles choses car tout m'interesse</a><span className="font-medium"> ( en ce moment je me documente sur l'impression 3D et le traitement d'image avec Matlab )</span>. Je participe également en tant que bénévole pour l'association{" "}
