    ...
    >
      ...
      {showImage && (
          <div className="absolute right-[0%] top-[15%]">
            <img src="riz.png" alt="riz" className="w-[25rem] h-[20rem]" />
          </div>
        )}
      <p className="mb-3 relative">
        ...
        <a href="./riz2.png" target="_blank" className="font-medium text-blue-800 hover:text-gray-800 " onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}> ( en ce moment je me documente sur l'impression 3D, le traitement d'image avec Matlab et la photométrie )</a>.
